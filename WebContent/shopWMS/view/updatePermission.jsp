						...
						<li>
							<div class="am-dropdown" data-am-dropdown>
								...
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									<h2>添加权限</h2>
									<form class="am-form" action="addpermission" method="post">
						...
						<li>
							<div class="am-dropdown" data-am-dropdown>
								...
								<button type="button"
									...
									搜索</button>
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									<form class="am-form" action="updatePermissionLike" method="post">
										<div class="am-form-group am-cf">
											<div class="zuo">按照姓名搜索</div>
											<div class="you">
												<input type="text" class="am-input-sm" id="permissionNameLike" name="permissionNameLike"
													placeholder="请输入姓名">
											</div>
										</div>
										<div class="am-form-group am-cf">
				...
				<div  class="fbneirong">
					...
					<form class="am-form am-g" action="">
						...
						<table width="100%"
							...
							<thead>
								<tr class="am-success">
									...
									<th class="table-author am-hide-sm-only">URL连接</th>
							...
							<tbody>
								<c:forEach items="${permissionList}" var="permission">
									<tr>
										...
										<td><c:out value="${permission.pid}"></c:out></td>
										<td><c:out value="${permission.pname}"></c:out></td>
										<td><c:out value="${permission.purl}"></c:out></td>
										<td><c:out value="${permission.pmessage}"></c:out></td>
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<a class="am-btn am-btn-default am-btn-xs am-text-secondary am-round"
													title="修改管理员信息" href="permissionToUpdate?permissionId=${permission.pid}&permissionName=${permission.pname}&permissionUrl=${permission.purl}&permissionMessage=${permission.pmessage}">
														<span class="am-icon-pencil-square-o"></span>
													</a>
													<a class="am-btn am-btn-default am-btn-xs am-text-danger am-round"
													title="删除管理员" href="deletePermission?permissionId=${permission.pid}">
						...
						<ul class="am-pagination am-fr">
							...
							<li><a href="updatePermission?pageNumberX=1">首页</a></li>
							<li><a href="updatePermission?pageNumberX=${pageNumberX-1 }">上一页</a></li>
							<li><a href="updatePermission?pageNumberX=${pageNumberX+1 }">下一页</a></li>
							<li><a href="updatePermission?pageNumberX=${pageAll}">尾页</a></li>
							<li>总页数： ${pageAll} 页</li> --%>
							<li class="am-disabled">当前是第 ${pageNumberX } 页</li>
							<li><a href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=1">首页</a></li>
							<li><a href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=${pageNumberX-1 }">上一页</a></li>
							<li><a href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=${pageNumberX+1 }">下一页</a></li>
							<li><a href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=${pageAll}">尾页</a></li>
							<li>总页数： ${pageAll} 页</li>
						</ul>
