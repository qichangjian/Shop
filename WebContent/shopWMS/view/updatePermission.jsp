			...
			<div class="daohang">
				<ul>
					<li><button type="button"
							class="am-btn am-btn-default am-radius am-btn-xs">权限操作列表</li>
								...
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									...
									<form class="am-form" action="addpermission" method="post">
										<div class="am-form-group am-cf">
											...
											<div class="you">
												<input type="text" class="am-input-sm" id="pname"
													name="pname" placeholder="请输入权限名">
											</div>
										</div>
										<div class="am-form-group am-cf">
										...
										<div class="am-form-group am-cf">
											...
											<div class="you">
												<input type="text" class="am-input-sm" id="pmessage"
													name="pmessage" placeholder="请输入对此权限描述">
											</div>
										</div>
										<div class="am-form-group am-cf">
						...
						<li>
							<div class="am-dropdown" data-am-dropdown>
								...
								<button type="button"
									...
									搜索</button>
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									<form class="am-form" action="updatePermissionLike"
										method="post">
										<div class="am-form-group am-cf">
											<div class="zuo">按照姓名搜索</div>
											<div class="you">
												<input type="text" class="am-input-sm"
													id="permissionNameLike" name="permissionNameLike"
													placeholder="请输入姓名">
											</div>
										</div>
										<div class="am-form-group am-cf">
				...
				<div class="fbneirong">
					...
					<form class="am-form am-g" action="">
											...
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<a
														...
														title="修改管理员信息"
														href="permissionToUpdate?permissionId=${permission.pid}&permissionName=${permission.pname}&permissionUrl=${permission.purl}&permissionMessage=${permission.pmessage}">
														<span class="am-icon-pencil-square-o"></span>
													</a> <a
														class="am-btn am-btn-default am-btn-xs am-text-danger am-round"
														title="删除管理员"
														href="deletePermission?permissionId=${permission.pid}">
						...
						<ul class="am-pagination am-fr">
							...
							<li><a
								href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=1">首页</a></li>
							<li><a
								href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=${pageNumberX-1 }">上一页</a></li>
							<li><a
								href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=${pageNumberX+1 }">下一页</a></li>
							<li><a
								href="updatePermissionLike?permissionNameLike=${permissionNameLike}&pageNumberX=${pageAll}">尾页</a></li>
							<li>总页数： ${pageAll} 页</li>
						</ul>
