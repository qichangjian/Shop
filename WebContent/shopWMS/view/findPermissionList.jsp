			...
			<div class="daohang">
				<ul>
					<li><button type="button"
							class="am-btn am-btn-default am-radius am-btn-xs">权限列表</li>
				</ul>
			</div>
				...
				<div class="fbneirong">
					...
					<form class="am-form am-g" action="">
						...
						<ul class="am-pagination am-fr">
							...
							<li><a href="findPermissionList?pageNumberX=1">首页</a></li>
							<li><a
								href="findPermissionList?pageNumberX=${pageNumberX-1 }">上一页</a></li>
							<li><a
								href="findPermissionList?pageNumberX=${pageNumberX+1 }">下一页</a></li>
							<li><a href="findPermissionList?pageNumberX=${pageAll}">尾页</a></li>
							<li>总页数： ${pageAll} 页</li>
						</ul>
					...
					<div class="foods" style="margin-top: 250px;">
						<ul>
