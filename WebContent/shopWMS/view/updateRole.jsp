			...
			<div class="daohang">
				<ul>
					<li><button type="button"
							class="am-btn am-btn-default am-radius am-btn-xs">角色操作列表</li>
								...
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									...
									<form class="am-form" action="addrole" method="post">
										<div class="am-form-group am-cf">
											...
											<div class="you">
												<input type="text" class="am-input-sm" id="rname"
													name="rname" placeholder="请输入角色名">
											</div>
										</div>
										...
										<div class="am-form-group am-cf">
											...
											<div class="you">
												<input type="text" class="am-input-sm" id="rmessage"
													name="rmessage" placeholder="请输入对此角色描述">
											</div>
										</div>
										<div class="am-form-group am-cf">
								...
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									<form class="am-form" action="updateRoleLike" method="post">
										<div class="am-form-group am-cf">
											...
											<div class="you">
												<input type="text" class="am-input-sm" id="roleNameLike"
													name="roleNameLike" placeholder="请输入角色名">
											</div>
										</div>
										<div class="am-form-group am-cf">
				...
				<div class="fbneirong">
					...
					<form class="am-form am-g" action="">
											...
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<a
														...
														title="查看该角色权限"
														href="roleAndPermission?roleId=${role.rid}&roleName=${role.rname}"><span
														class="am-icon-search"></span></a> <a
														class="am-btn am-btn-default am-btn-xs am-text-secondary am-round"
														title="修改该角色信息"
														href="roleToUpdate?roleId=${role.rid}&roleName=${role.rname}&roleMessage=${role.rmessage}">
														<span class="am-icon-pencil-square-o"></span>
													</a> <a
														class="am-btn am-btn-default am-btn-xs am-text-danger am-round"
														title="删除该角色" href="deleteRole?roleId=${role.rid}"> <span
						...
						<ul class="am-pagination am-fr">
							...
							<li class="am-disabled">当前是第 ${pageNumberX } 页</li>
							<li><a
								href="updateRoleLike?roleNameLike=${roleNameLike}&pageNumberX=1">首页</a></li>
							<li><a
								href="updateRoleLike?roleNameLike=${roleNameLike}&pageNumberX=${pageNumberX-1 }">上一页</a></li>
							<li><a
								href="updateRoleLike?roleNameLike=${roleNameLike}&pageNumberX=${pageNumberX+1 }">下一页</a></li>
							<li><a
								href="updateRoleLike?roleNameLike=${roleNameLike}&pageNumberX=${pageAll}">尾页</a></li>
							<li>总页数： ${pageAll} 页</li>
						</ul>
