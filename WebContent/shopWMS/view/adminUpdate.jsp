		...
		<div class=" admin-content">
			<div class="daohang">
				<ul>
					<li><button type="button"
							class="am-btn am-btn-default am-radius am-btn-xs">管理员修改</li>
				</ul>
			</div>
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					...
					<form class="am-form" action="adminUpdate" method="post">
						<div class="am-form-group am-cf">
							<div class="zuo">管理员Id：</div>
							<div class="you">
								<input type="text" class="am-input-sm" id="aid" name="aid"
									readOnly placeholder="${adminId}" value="${adminId}">
							</div>
						</div>
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" id="aname" name="aname"
									placeholder="${adminName}" value="${adminName}">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="zuo">管理员密码：</div>
							<div class="you">
								<input type="text" class="am-input-sm" id="apassword"
									name="apassword" placeholder="${adminPassword}"
									value="${adminPassword}">
							</div>
						</div>
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" id="amessage"
									name="amessage" placeholder="${adminMessage}"
									value="${adminMessage}">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="you" style="margin-left: 22%;">
								<button type="submit" class="am-btn am-btn-success am-radius">确认修改此管理员</button>
							</div>
						</div>
					</form>
				</div>
