						...
						<li>
							<div class="am-dropdown" data-am-dropdown>
								...
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									<h2>添加管理员</h2>
									<form class="am-form" action="addAdmin" method="post">
										...
										<div class="am-form-group am-cf">
											<div class="you" style="margin-left: 22%;">
												<button type="submit"
													class="am-btn am-btn-success am-radius">注册并关闭窗口</button>
											</div>
										</div>
									</form>
								</div>
						...
						<li>
							<div class="am-dropdown" data-am-dropdown>
								...
								<button type="button"
									...
									搜索</button>
								<div class="am-dropdown-content am-kai" style="width: 400px;">
									<form class="am-form" action="updateAdminLike" method="post">
										<div class="am-form-group am-cf">
