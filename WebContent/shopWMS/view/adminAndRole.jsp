			...
			<div class="daohang">
				<ul>
					<li><button type="button"
							class="am-btn am-btn-default am-radius am-btn-xs">管理员角色修改</li>
				</ul>
			</div>
			...
			<div class="admin-biaogelist">
				...
				<div class="am-form am-g">
					<table width="95%"
						...
						<h2 class="am-kai">
							<center style="color: green;">${adminName }管理员具有角色：</center>
						</h2>
						<%-- ${deleteRolePermission} --%>
						<thead>
							<tr class="am-success">
								<th class="table-author am-hide-sm-only">管理员Id</th>
								<th class="table-author am-hide-sm-only">角色Id</th>
						...
						<tbody>
							<tr>
								<td colspan="5">${rerrtip}</td>
							</tr>
							<c:forEach items="${rlists}" var="rlists">
								<tr>
									<td><c:out value="${adminId }"></c:out></td>
									<td><c:out value="${rlists.rid }"></c:out></td>
									<td><c:out value="${rlists.rname }"></c:out></td>
									<td><c:out value="${rlists.rmessage}"></c:out></td>
									<td>
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a
													...
													title="删除角色这个权限"
													href="deleteAdminRole?adminId=${adminId }&roleId=${rlists.rid }"><span
													class="am-icon-minus"></span></a>
											</div>
										</div>
				...
				<div class="am-form am-g">
					<table width="95%"
						class="am-kai  am-table am-table-bordered am-table-radius am-table-striped">
						<h2 class="am-kai">
							<center style="color: red;">${adminName }角色没有下列权限：</center>
						</h2>
						<thead>
							<tr class="am-danger">
								<th class="table-author am-hide-sm-only"><p
										style="color: blue;">角色Id</p></th>
						...
						<tbody>
							<tr>
								<td colspan="5">${rerrtip1}</td>
							</tr>
							<c:forEach items="${norlist}" var="rlists">
								<tr>
									<td><c:out value="${adminId }"></c:out></td>
									<td><c:out value="${rlists.rid }"></c:out></td>
									<td><c:out value="${rlists.rname }"></c:out></td>
										...
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a
													class="am-btn am-btn-default am-btn-xs am-text-danger am-round"
													title="角色添加这个权限"
													href="addAdminRole?adminId=${adminId }&roleId=${rlists.rid }"><span
