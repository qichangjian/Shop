		...
		<div class=" admin-content">
			<div class="daohang">
				<ul>
					<li><button type="button"
							class="am-btn am-btn-default am-radius am-btn-xs">角色修改</li>
			...
			<div class="admin-biaogelist">
				...
				<div class="fbneirong">
					...
					<form class="am-form" action="roleUpdate" method="post">
						<div class="am-form-group am-cf">
							<div class="zuo">角色Id：</div>
							<div class="you">
								<input type="text" class="am-input-sm" id="rid" name="rid"
									readOnly placeholder="${roleId}" value="${roleId}">
							</div>
						</div>
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" id="rname" name="rname"
									placeholder="${roleName}" value="${roleName}">
							</div>
						</div>
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" id="rmessage"
									name="rmessage" placeholder="${roleMessage}"
									value="${roleMessage}">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="you" style="margin-left: 22%;">
								<button type="submit" class="am-btn am-btn-success am-radius">确认修改此角色</button>
							</div>
						</div>
					</form>
				</div>
