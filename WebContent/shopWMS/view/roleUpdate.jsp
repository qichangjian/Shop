				...
				<div  class="fbneirong">
					...
					<form class="am-form" action="roleUpdate" method="post">
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" id="rid" name="rid" readOnly
									placeholder="${roleId}" value="${roleId}">
							</div>
						</div>
						<div class="am-form-group am-cf">
						...
						<div class="am-form-group am-cf">
							...
							<div class="you">
								<input type="text" class="am-input-sm" id="rmessage" name="rmessage"
									placeholder="${roleMessage}" value="${roleMessage}">
							</div>
						</div>
						<div class="am-form-group am-cf">
							<div class="you" style="margin-left: 22%;">
								<button type="submit"
									class="am-btn am-btn-success am-radius">确认修改此角色</button>
							</div>
						</div>
					</form>
				</div>
