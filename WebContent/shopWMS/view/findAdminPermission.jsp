			...
			<div class="admin-biaogelist">
				...
				<div class="am-form am-g">
					<table width="100%"
							...
							<h2 class="am-kai"><center style="color:green; ">${adminName }具有权限：</center></h2>
							<thead>
								<tr class="am-success">
							...
							<tbody>
								<tr><td colspan="2"><p style="color:red; ">${permissionTip}</p></td></tr>
								<c:forEach items="${plist0}" var="plists">
									<tr>
					 ...
					 <center>
					  <a class="am-btn am-btn-default am-btn-ls am-text-danger am-round" href="findAdminList?pageNumberX=1">返回</a>
					</center>
				</div>
