			...
			<div class="daohang">
				<ul>
					<li><button type="button"
							class="am-btn am-btn-default am-radius am-btn-xs">角色权限修改</li>
			...
			<div class="admin-biaogelist">
				...
				<div class="am-form am-g">
					<table width="95%"
						...
						<tbody>
							<tr>
								<td colspan="5">${errtip}</td>
							</tr>
							<c:forEach items="${plists}" var="plists">
								<tr>
									<td><c:out value="${roleId }"></c:out></td>
									<td><c:out value="${plists.pid }"></c:out></td>
										...
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a
													...
													title="删除角色这个权限"
													href="deleteRolePermission?roleId=${roleId }&permissionId=${plists.pid }"><span
				...
				<div class="am-form am-g">
					<table width="95%"
						class="am-kai  am-table am-table-bordered am-table-radius am-table-striped">
						<h2 class="am-kai">
							<center style="color: red;">${roleName }角色没有下列权限：</center>
						</h2>
						<thead>
							<tr class="am-danger">
						...
						<tbody>
							...
							<c:forEach items="${noplist}" var="plists">
								<tr>
									<td><c:out value="${roleId }"></c:out></td>
									<td><c:out value="${plists.pid }"></c:out></td>
									<td><c:out value="${plists.pname }"></c:out></td>
										...
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												<a
													class="am-btn am-btn-default am-btn-xs am-text-danger am-round"
													title="角色添加这个权限"
													href="addRolePermission?roleId=${roleId }&permissionId=${plists.pid }"><span
