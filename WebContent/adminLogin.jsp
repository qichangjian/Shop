			...
			<div class="tpl-login">
				<div class="tpl-login-content">
					<div class="tpl-login-logo">
							<center><img src="shopWMS/i/adminlogin.PNG" /></center>
					</div>
					...
					<form class="am-form tpl-form-line-form" action="adminlogin" method="post">
						...
						<div class="am-form-group">
							<input type="password" class="tpl-form-input" id="apassword" name="apassword" placeholder="请输入密码">
							<c:if test="${err == 1}">
						...
						<div class="am-form-group">
							<button type="submit" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">登录后台管理平台</button>
						</div>
					</form>
				</div>
			</div>
