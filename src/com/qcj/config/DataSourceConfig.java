...
/**
 * @Configuration 声明当前类是一个配置类（代替xml文件的类） @ComponentScan("com.qcj")
 *                配置扫描位置 @PropertySource(value={"classpath:jdbc.properties"},ignoreResourceNotFound=true)
...
public class DataSourceConfig {
	...
	/**
	 * 声明该方法将返回一个Bean，Bean将放入容器中备用 Druid是阿里巴巴数据缓冲池
	 */
